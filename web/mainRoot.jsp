    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
          <li class="active"><a href="mainRoot.jsp">Home</a></li>
          <li><a href="ControladorRoot?accion=listar">Reports</a></li>
          
          <li><a href="userRoot.jsp">Users</a></li>
